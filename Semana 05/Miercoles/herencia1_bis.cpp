...
///Especificadore de acceso
    ...
    ///protected: la misma protección que private, pero permite el acceso directo a las propiedades
...
///FORMAS DE HEREDAR
    ...
    ///si se hereda de manera pública (public) lo que está en privado de la clase base, pasa a la parte privada
    ///de la derivada, y lo público pasa a la parte pública
...
public:
        ...
        void otroSetDeDNI(int valor){DNI=valor;} ///no se puede hacer porque se rompe el principio más elemental
